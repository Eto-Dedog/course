...
inputRange.addEventListener('input', long)
...
const appData = {
    ...
    showResult: function() {
        ...
        totalCount.value = appData.counts
        totalCountOther.value = appData.servicePricesPercent + appData.servicePricesNumber
        fullTotalCount.value = appData.fullPrice
        totalCountRollback.value = appData.serviePercentPrice
    },
    addScreens: function() {
    ...
    addPrice: function () {
      ...
      for(let key in appData.servicesPercent) {
        appData.serviePercentPrice =  appData.fullPrice - (appData.fullPrice * (appData.servicesPercent[key] / 100))
      }
